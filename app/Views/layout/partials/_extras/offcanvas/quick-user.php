				...
				<div class="navi mt-2">
					<a href="#" class="navi-item">
						<span class="navi-link p-0 pb-2">
							...
							<span class="navi-text text-muted text-hover-primary"> <?= session()->get('email') ?>
							</span>
						</span>
					</a>
					<a href="<?= base_url('keluar'); ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Keluar</a>
				</div>
			</div>
		</div>
